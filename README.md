...
- Core pages remain readable without JavaScript; JavaScript adds homepage inventory updates, resume navigation, attribution, navigation behavior, interactive presentation controls, and project architecture views.
...
- Automated checks fail on broken internal references, missing metadata, duplicate IDs, document-level mobile overflow, missing source attribution, missing resume/presentation routes, and interaction regressions.
